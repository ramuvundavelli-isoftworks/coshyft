import svgPaths from "./svg-mif262ekod";
...
function Container() {
  return (
    <div className="h-[1722px] relative shrink-0 w-[1461px]" data-name="Container" style={{ backgroundImage: "linear-gradient(170.625deg, rgb(239, 255, 248) 0.15476%, rgb(246, 246, 246) 28.297%)" }}>
      <MainContent />
      <Section />
    </div>
  );
...
function Section1() {
  return <div className="h-0 shrink-0 w-[1461px]" data-name="Section" />;
}

function PK() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[1722px] items-start left-0 top-[64px]" data-name="pK">
      <Container />
      <Section1 />
    </div>
  );
